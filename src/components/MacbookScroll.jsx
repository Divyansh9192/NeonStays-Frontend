...
// {TO Run This Example TO This}
{/* <MacbookScroll
        title={
          <span className="text-foreground font-playfair text-4xl md:text-5xl lg:text-6xl font-bold">
           Stay Inspired <br /> 
            <span className="text-muted-foreground">Built to help You!</span>
          </span>
        }
